...
function SearchResult(){
    ...
    const getMovies = async(query) => {
        ...
        const result = await axios({
            method: 'get',
            url: `/api/v2/list_movies.json?query_term=${query}`,
            dataType: 'json',
        })
        console.log(result)
    ...
    const getSearchBoxOfficeData=async()=>{
        ...
        const result1 = await axios.get('/api/get/movie_popular_search')
        const result2 = await axios.get('/api/get/actor_popular_search')
        const result3 = await axios.get('/api/get/box_office')
        console.log(result1)
        console.log(result2)
        console.log(result3)
