...
import '../../css/SearchResult/MovieView.css'
    ...
    useEffect(() => {
      ...
      const getMovieDetails=async(id)=>{
        ...
        const result = await axios({
            method: 'get',
            url: `/api/v2/movie_details.json?id=${id}`,
            dataType: 'json',
        })
        console.log(result)
                ...
                <div id='movie-desc'>
                    ...
                    <div id='movie-desc-info'>
                        ...
                        <ul id='movie-desc-right'>
                            ...
                            <li><span>박스오피스</span><span></span></li>
                        </ul>
                    </div>
                    <div id='movie-info-icon'>
                        <span>영화정보<span className='info'></span></span>
                    </div>
                </div>
            </div>
            <div id='movie-tab'>
